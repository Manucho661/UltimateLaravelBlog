...
@section('content')
    ...
    <div class="home">
        <div
          ...
          data-image-src="../images/post.jpg"
          data-speed="0.8"
        ></div>
                            ...
                            <li class="comment">
                              <div class="comment_body">
                                ...
                                <div class="comment_content">
                                  <p>
                                    Pick the yellow peach that looks like a
                                    sunset with its red, orange, and pink coat
                                    skin, peel it off with your teeth. Sink them
                                    into unripened.
                                  </p>
                                </div>
                              </div>
                              ...
                              <ul class="comment_list">
                                <li class="comment">
                                  <div class="comment_body">
                                    ...
                                    <div class="comment_content">
                                      <p>
                                        Nulla facilisi. Aenean porttitor quis
                                        tortor id tempus. Interdum et malesuada
                                        fames ac ante ipsum primis in faucibus.
                                        Vivamus molestie varius tincidunt.
                                        Vestibulum congue sed libero ac sodales.
                                      </p>
                                    </div>
                                  </div>
                ...
                <div class="sidebar_section">
                  <div class="sidebar_title_container">
                    ...
                    <div class="sidebar_slider_nav">
                      <div
                        class="custom_nav_container sidebar_slider_nav_container"
                      >
                        ...
                        <ul
                          id="custom_dots"
                          class="custom_dots custom_dots_top"
                        >
                          <li class="custom_dot custom_dot_top active">
                            <span></span>
                          </li>
                          <li class="custom_dot custom_dot_top">
                            <span></span>
                          </li>
                          <li class="custom_dot custom_dot_top">
                            <span></span>
                            ...
                            <a href="post.html">
                              ...
                              >
                                ...
                                <div class="side_post_content">
                                  ...
                                  <small class="post_meta"
                                    >Katy Liu<span>Sep 29</span></small
                                  >
                                </div>
                              </div>
                            </a>
                  ...
                  <div class="sidebar_title_container">
                    ...
                    <div class="sidebar_slider_nav">
                      ...
                      >
                        ...
                        <ul
                          id="custom_dots"
                          class="custom_dots custom_dots_vid"
                        >
                  ...
                  <div class="sidebar_title_container">
                    ...
                    <div class="sidebar_slider_nav">
                      ...
                      >
                        ...
                        <ul
                          id="custom_dots"
                          class="custom_dots custom_dots_events"
                        >
                          <li class="custom_dot custom_dot_events active">
                            <span></span>
                          </li>
                          <li class="custom_dot custom_dot_events">
                            <span></span>
                          </li>
                          <li class="custom_dot custom_dot_events">
                            <span></span>
